...
const availableNiches = [
  "Motivacional", "Basketball", "Finance", "History", "Quiz", "Animals",
        ...
        <div className="flex flex-wrap gap-3 mb-10">
          {availableNiches.map((niche) => (
            ...
            <div className="mt-4 flex space-x-2">
              <Button variant="outline" className="bg-custom-card-bg border-custom-border-color text-custom-text-secondary hover:border-custom-yellow-accent hover:text-custom-yellow-accent">{t("geography")}</Button>
              <Button variant="outline" className="bg-custom-card-bg border-custom-border-color text-custom-text-secondary hover:border-custom-yellow-accent hover:text-custom-yellow-accent">{t("soccer_clips")}</Button>
              <Button variant="outline" className="bg-custom-card-bg border-custom-border-color text-custom-text-secondary hover:border-custom-yellow-accent hover:text-custom-yellow-accent">{t("educational")}</Button>
            </div>
{/* NOVA SEÇÃO: Nichos clicáveis */}
  ...
  {availableNiches.map((niche) => (
    <Button
      ...
      className={`px-4 py-2 rounded-full border text-sm font-medium transition-colors ${
        selectedNiches.includes(niche)
          ? "bg-custom-yellow-accent text-custom-text-on-yellow border-custom-yellow-accent"
          : "bg-custom-card-bg text-custom-text-secondary border-custom-border-color hover:border-custom-yellow-accent hover:text-custom-yellow-accent"
      }`}
    >
